...
export default function AlertsPage() {
  ...
  const [, setHoveredStatus] = useState<'active' | 'acknowledged' | 'resolved' | null>(null)
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 bg-white p-4 rounded-lg shadow-sm">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Monitor and manage network alerts</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition-all hover:shadow-md">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Status Overview</h3>
          ...
          <div className="mt-2 flex justify-between items-center">
            <div className="space-y-3">
              ...
              >
                ...
                <Badge variant="outline" className="ml-2 bg-white text-red-600 border-red-200">
                  {counts.active}
                </Badge>
              </div>
              <div 
              ...
              <div 
                ...
                style={{
                  background: alerts.length > 0 
                    ? `conic-gradient(
                        #EF4444 0deg ${(counts.active / alerts.length) * 360}deg,
                        #3B82F6 ${(counts.active / alerts.length) * 360}deg ${((counts.active + counts.acknowledged) / alerts.length) * 360}deg,
                        #22C55E ${((counts.active + counts.acknowledged) / alerts.length) * 360}deg 360deg
                      )`
                    : '#E5E7EB'
                }}
              >
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition-all hover:shadow-md">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Severity Distribution</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-100 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${(counts.critical / alerts.length) * 100}%` }}
                ></div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-100 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${(counts.warning / alerts.length) * 100}%` }}
                ></div>
              </div>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition-all hover:shadow-md">
          ...
          <div className="mt-2 space-y-4">
            <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
              ...
              <div>
                <div className="text-sm"><span className="font-medium">Admin</span> acknowledged an alert</div>
            ...
            <div className="flex items-start gap-3 pb-3 border-b border-gray-100">
              ...
              <div>
                <div className="text-sm"><span className="font-medium">System</span> created 3 new alerts</div>
                <div className="text-xs text-gray-500 mt-0.5">Today at 10:45 AM</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm"><span className="font-medium">Tech1</span> resolved 5 alerts</div>
      ...
      {selectedAlerts.length > 0 && (
        <div className="bg-[#5BB6B7]/10 border border-[#5BB6B7]/30 p-3 rounded-lg flex items-center justify-between">
          <div className="text-sm">
            <span className="font-medium">{selectedAlerts.length}</span> alerts selected
          </div>
          <div className="flex gap-2">
            <Button size="sm" variant="outline" className="text-[#5BB6B7] border-[#5BB6B7]/30 hover:bg-[#5BB6B7]/10">
        ...
        <Table>
          ...
          <TableBody>
            {filteredAlerts.length === 0 ? (
              <TableRow>
                <TableCell colSpan={6} className="h-32 text-center bg-gray-50/50">
              ...
              filteredAlerts.map((alert) => (
                <TableRow key={alert.id} className="group hover:bg-gray-50/80">
                  ...
                  <TableCell>
                    ...
                    <div className="text-sm text-gray-500 mt-0.5 line-clamp-1">{alert.description}</div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="text-sm text-gray-900">{new Date(alert.timestamp).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</div>
                  ...
                  <TableCell>
                    <Badge className={cn(
                      ...
                      alert.status === 'active' && "bg-red-100 text-red-800 border-red-200 hover:bg-red-200",
                      alert.status === 'acknowledged' && "bg-blue-100 text-blue-800 border-blue-200 hover:bg-blue-200",
                      alert.status === 'resolved' && "bg-green-100 text-green-800 border-green-200 hover:bg-green-200"
                    )}>
                      {alert.status}
                    </Badge>
                  </TableCell>
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40">
                          ...
                          {alert.status === 'active' && (
                            <DropdownMenuItem onClick={() => handleAcknowledge(alert.id)} className="text-blue-600">
                          ...
                          {(alert.status === 'active' || alert.status === 'acknowledged') && (
                            <DropdownMenuItem onClick={() => handleResolve(alert.id)} className="text-green-600">
